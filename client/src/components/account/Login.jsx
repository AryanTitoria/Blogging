...
const Login = () => {
  ...
  const signupUser = async () => {
    console.log('Signup data being sent:', signup);
      ...
      <Box>
        ...
        {account === 'login' ? (
          <Wrapper>
            ...
            <TextField variant="standard" value={login.password} onChange={(e) => onValueChange(e)} name="username" label="Enter Password" type="password" />
